            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 mb-8 shadow-2xl">
                    ...
                    <div className="mb-6">
                        <div className="relative">
                            <input
                                ...
                                className="w-full rounded-2xl px-12 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium"
                                style={{
                            ...
                            />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 opacity-40">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        {/* Season Filter */}
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-wider mb-2 opacity-60">Season</label>
                            <select
                                value={filters.season}
                                onChange={(e) => handleFilterChange('season', e.target.value)}
                                className="w-full rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all cursor-pointer font-medium"
                                style={{
                                    background: 'var(--card-bg)',
                                    color: 'var(--text-primary)',
                                    border: '2px solid var(--border-color)'
                        ...
                        {/* Occasion Filter */}
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-wider mb-2 opacity-60">Occasion</label>
                            <select
                        ...
                        {/* Gender Filter */}
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-wider mb-2 opacity-60">Gender</label>
                            <select
                        ...
                        {/* Sort By */}
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-wider mb-2 opacity-60">Sort By</label>
                            <select
                                value={sortBy}
