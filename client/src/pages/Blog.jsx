      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {blogPosts.map((post, idx) => (
          ...
          >
            ...
            {/* Content */}
            <div className="p-8">
              <div className="flex justify-between items-center text-xs font-bold tracking-widest opacity-60 mb-4 uppercase">
                <span>{post.date}</span>
              ...
              <button className="text-sm font-bold tracking-widest uppercase border-b border-white/20 pb-1 group-hover:border-indigo-400 group-hover:text-indigo-300 transition-all">
                Read Article
              </button>
            </div>
          </div>
