               ...
               <div className="flex overflow-x-auto gap-3 pb-4 snap-x snap-mandatory scrollbar-hide">
                    {forecast.map((day, index) => (
                         <div
                              ...
                              className="flex-shrink-0 w-28 p-4 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/10 flex flex-col items-center justify-center snap-start hover:bg-white/20 transition cursor-pointer group"
                         >
